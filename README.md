...
Эвристики для поиска правильных абстракций:
- Могу ли я выбрать знакомую структуру данных Python для преставления состояния запутанной системы, а затем попыпаться представить себе единственную функцию, которая может возращать это состояние.
- Где я могу провесит грань между моими системами и вырезать шок, чтобы вставить эту абстракцию.
- Какой есть разумный способ разделения элементов кода на компоненты с разными особенностями. Какие неявные концепции можно сделать явными?
